    ...
    return (
        <TemplateTab tabName="home">
            <div className="flex flex-row items-center gap-1 sm:gap-2 md:gap-4 2xl:gap-8 mb-4 sm:mb-6 md:mb-8 2xl:mb-12">
                ...
                <h1 className="text-3xl/8 sm:text-6xl/16 md:text-7xl/20 lg:text-8xl/24 2xl:text-[10rem]/[12rem] font-stretch-ultra-expanded tracking-tighter bg-gradient-to-br from-blue-800 to-purple-500 bg-clip-text text-transparent">
                    ZAIDAN
                    <br />
                    SANI
                </h1>
